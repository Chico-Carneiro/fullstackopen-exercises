...
```mermaid
	...
	Note left of server: The server sends a URL redirect, asking the browser to do a new HTTP GET request to the address defined in the header's Location - the address notes
	...
	server-->>browser: HTML document
        ...
        activate server
        server-->>browser: [{ "content": "HTML is easy", "date": "2023-1-1" }, ... , { "content": "whatever is being submited", "date": "*date and time the note was created*" } ]
        deactivate server    
